...
topology = get_topology('/content/drive/MyDrive/optical-rl-gym-Modif/examples/topologies/nsfnet_chen.txt', 'new_topology', modulations, k_paths=k_paths)

with open(f'/content/drive/MyDrive/optical-rl-gym-Modif/examples/topologies/nsfnet_eon_{k_paths}-paths.h5', 'wb') as f:
