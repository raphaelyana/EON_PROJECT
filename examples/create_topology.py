...
topology = get_topology('/content/drive/MyDrive/optical-rl-gym-Modif/examples/topologies/new_topology.txt', 'new_topology', modulations, k_paths=k_paths)

with open(f'/content/drive/MyDrive/optical-rl-gym-Modif/examples/topologies/new_topology_eon_{k_paths}-paths.h5', 'wb') as f:
